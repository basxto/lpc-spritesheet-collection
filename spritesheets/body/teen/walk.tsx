...
<tileset version="1.2" tiledversion="1.2.0" name="teen" tilewidth="64" tileheight="64" tilecount="36" columns="9">
 <properties>
  <property name="author" value="elizawy"/>
  <property name="basedOn" value="../female/female_walkcycle.tsx"/>
 ...
 <tile id="4">
  <properties>
   <property name="animation" value="wc"/>
   <property name="direction" type="int" value="2"/>
   <property name="frame" type="int" value="5"/>
  </properties>
 </tile>
 <tile id="5">
  <properties>
   <property name="animation" value="wc"/>
   <property name="direction" type="int" value="2"/>
   <property name="frame" type="int" value="6"/>
  </properties>
 </tile>
 <tile id="6">
  <properties>
   <property name="animation" value="wc"/>
   <property name="direction" type="int" value="2"/>
   <property name="frame" type="int" value="7"/>
  </properties>
 </tile>
 <tile id="7">
  <properties>
   <property name="animation" value="wc"/>
   <property name="direction" type="int" value="2"/>
   <property name="frame" type="int" value="8"/>
  </properties>
 </tile>
 <tile id="9">
  <properties>
